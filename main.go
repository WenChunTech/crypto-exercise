...
func main() {
	key := "061cecfd897548208c76c04b6e7fb"
	data := "parentFolderId=11463310842361563&fileName=conf.xml&fileSize=369&sliceSize=10485760&fileMd5=bfb07d9b177e301db54230699a735f15&sliceMd5=bfb07d9b177e301db54230699a735f15"
	ret := EcbEncrypt([]byte(data), []byte(key)[:16])
